          ...
          {categoriesData &&
            categoriesData.map((i) => (
              <Link
                ...
                className="group w-full h-25 flex items-center justify-between overflow-hidden rounded-lg border border-border bg-background px-3 text-left transition-all hover:border-primary hover:shadow-md"
                key={i.id}
              >
